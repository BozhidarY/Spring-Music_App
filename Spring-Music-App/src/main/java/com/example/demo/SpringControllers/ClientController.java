...
public class ClientController {
    ...
    public ResponseEntity<?> AddSongToPlaylist(@PathVariable String username, @RequestBody InPlaylistSearchDTO inPlaylistSearchDTO){
        ...
        String playlistChoice = inPlaylistSearchDTO.getPlaylistChoice();
        Playlist choosenPlaylist = clientService.searchPlaylistFromLibrary(playlistChoice);
        if(choosenPlaylist != null){
            String songChoice = inPlaylistSearchDTO.getSongChoice();
            if(!clientService.addSong(choosenPlaylist, songChoice)) {
                return ResponseEntity.status(HttpStatus.NOT_FOUND).body("No song with that name");
            }
    ...
    public ResponseEntity<?> removeSongFromPlaylist(@PathVariable String username, @RequestBody InPlaylistSearchDTO inPlaylistSearchDTO){
        ...
        if(choosenPlaylist != null){
            String songChoice = inPlaylistSearchDTO.getSongChoice();
            if(!clientService.deleteSong(choosenPlaylist, songChoice)){
                return ResponseEntity.status(HttpStatus.NOT_FOUND).body("No song with than name");
            }
    ...
    @PostMapping("/{username}/dashboard/editMenu/deletePlaylist")
    public ResponseEntity<?> deletePlaylist(@PathVariable String username, @RequestBody NameSearchDTO playlistName){
        ...
        if(clientService.deletePlaylist(deletePlaylistName)){
